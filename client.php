        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<!-- <button class="bt" align="center" onClick="window.print()">Print</button> -->
...
<?php
	...
	$sql = "SELECT client_id,agent_id,client_password,name,birth_date,nid,phone,address,policy_id FROM client";
	$result = $conn->query($sql);
	
	echo "<table class=\"table\">\n";
    echo "  <tr>\n";
    echo "    <th>CLIENT ID</th>\n";
    echo"<th>CLIENT PASSWORD</th>\n";
    echo " <th>Agent ID</th>\n";
