...
include'connection.php';
	...
	$sql = "SELECT recipt_no, client_id,payment_date,payment_method, month, amount, due, fine, agent_id from payment where recipt_no='$recipt_no'";
	...
	while($row = $result->fetch_assoc()) {
        ...
        echo "<label for=\"fname\">Payment Date</label>";
	    echo "<input type=\"text\" recipt_no=\"fname\" name=\"payment_date\" placeholder=\"payment_date..\" value=\"$row[payment_date]\">";
        echo "<label for=\"fname\">Payment Method</label>";
	    echo "<input type=\"text\" recipt_no=\"fname\" name=\"payment_method\" placeholder=\"payment_method..\" value=\"$row[payment_method]\">";
