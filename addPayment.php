...
payment date: <input type="date" name="payment_date" value="<?php echo"$payment_date"; ?>" required><br>
payment method: <input type="date" name="payment_method" value="<?php echo"$payment_method"; ?>" required><br>
